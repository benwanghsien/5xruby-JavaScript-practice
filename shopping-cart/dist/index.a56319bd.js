...
})({"hl4Yf":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const state = [];
function filterState(state1, productArr) {
    res = {};
    if (state1.length === 0) {
        res[productArr[0]] = [
            1,
...
},{"bootstrap/dist/css/bootstrap.css":"jJvnD","@fortawesome/fontawesome-free/css/all.css":"8OILE"}],"jJvnD":[function() {},{}],"8OILE":[function() {},{}]},["hl4Yf","bAabt"], "bAabt", "parcelRequirefe43")
