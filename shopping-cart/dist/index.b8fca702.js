...
var _shoppingCartFunctionJs = require("./shoppingCartFunction.js");
...
catListGroup.forEach((ele)=>{
    ele.addEventListener("click", (e)=>{
        if (e.target.tagName === "BUTTON" || e.target.tagName === "I") {
            ...
            const price = Number(e.currentTarget.children[1].children[1].innerText.slice(1));
            _shoppingCartFunctionJs.checkState(cartState, [
                name,
                price
            ]);
            _shoppingCartFunctionJs.updateCart(name, cartState);
        }
        // TODO del
...
document.querySelector("section.cart > button.btn").addEventListener("click", ()=>{
    _shoppingCartFunctionJs.deleteWholeCart(cartState);
});
...
},{"bootstrap/dist/css/bootstrap.css":"jJvnD","@fortawesome/fontawesome-free/css/all.css":"8OILE","./shoppingCartFunction.js":"9lQ2I"}],"jJvnD":[function() {},{}],"8OILE":[function() {},{}],"9lQ2I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateCart", ()=>updateCart
);
parcelHelpers.export(exports, "deleteWholeCart", ()=>deleteWholeCart
);
parcelHelpers.export(exports, "checkState", ()=>checkState
);
...
function updateTotalPrice() {
    const subTotalTdArr = [].slice.call(document.querySelectorAll("tbody tr :nth-child(4)"));
...
function deleteWholeCart(state) {
    for (let keys of Object.keys(state))state[keys][0] = 0;
...
function updateCart(name, state) {
    ...
    if (catCart) {
        ...
        document.querySelector("tbody > :last-child").addEventListener("click", function(e) {
...
function checkState(state, productArr) {
    if (!state[productArr[0]]) state[productArr[0]] = [
        1,
        productArr[1]
    ];
    else state[productArr[0]][0]++;
}
...
},{}]},["d3wGw","3cYfC"], "3cYfC", "parcelRequirefe43")
