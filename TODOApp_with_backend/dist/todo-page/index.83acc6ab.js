...
})({"2wiV3":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "01ce14f383acc6ab";
...
},{}],"3SXP3":[function(require,module,exports) {
...
function postTodo(url, data) {
    ...
    _axiosDefault.default.post(url, data, {
        headers: {
            Authorization: token
        }
    }).then((res)=>{
...
function deleteTodo(id) {
    const token = localStorage.getItem("token");
    _axiosDefault.default.delete(`https://todoo.5xcamp.us/todos/${id}`, {
        headers: {
            Authorization: token
        }
    });
...
function updateTodo(id, data) {
    const token = localStorage.getItem("token");
    _axiosDefault.default.put(`${API_BASE}/todos/${id}`, data, {
        headers: {
            Authorization: token
        }
    });
...
function toggleTodo(id) {
    const token = localStorage.getItem("token");
    const data1 = _axiosDefault.default.patch(`${API_BASE}/todos/${id}/toggle`, {}, {
        headers: {
            Authorization: token
        }
    }).then(({ data  })=>data
...
},{}]},["2wiV3","3SXP3"], "3SXP3", "parcelRequireda20")

//# sourceMappingURL=index.83acc6ab.js.map
